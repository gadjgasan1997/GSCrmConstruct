...
namespace GSCrm_Tools.Controllers.ApiControllers.DataMappingControllers
{
    ...
    [ApiController]
    public class BusinessComponentMapController : BusinessComponentMapController<ToolsContext>
    {
        public BusinessComponentMapController(ToolsContext context) : base(context)
        { }
    }
}
