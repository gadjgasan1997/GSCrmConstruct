...
namespace GSCrmLibrary.Controllers.ApiControllers.BusinessComponentControllers
{
    ...
    public class ControlUPController<TContext, TBUSFactory>
        : MainBusinessComponentController<ControlUP, BUSControlUP, TContext, DataBUSControlUPFR<TContext>, TBUSFactory>
        where TContext : MainContext, new()
        where TBUSFactory : BUSFactory<TContext>, new()
    {
        public ControlUPController(TContext context, IViewInfo viewInfo)
