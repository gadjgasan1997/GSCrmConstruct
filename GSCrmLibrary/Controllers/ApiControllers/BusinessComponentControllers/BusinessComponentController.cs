...
namespace GSCrmLibrary.Controllers.ApiControllers.BusinessComponentControllers
{
    ...
    public class BusinessComponentController<TContext, TBUSFactory>
        : MainBusinessComponentController<BusinessComponent, BUSBusinessComponent, TContext, DataBUSBusCompFR<TContext>, TBUSFactory>
        where TContext : MainContext, new()
        where TBUSFactory : BUSFactory<TContext>, new()
    {
        public BusinessComponentController(TContext context, IViewInfo viewInfo)
