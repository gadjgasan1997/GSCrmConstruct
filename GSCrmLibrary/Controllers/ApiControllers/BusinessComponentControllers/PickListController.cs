...
namespace GSCrmLibrary.Controllers.ApiControllers.BusinessComponentControllers
{
    ...
    public class PickListController<TContext, TBUSFactory>
        : MainBusinessComponentController<PickList, BUSPickList, TContext, DataBUSPickListFR<TContext>, TBUSFactory>
        where TContext : MainContext, new()
        where TBUSFactory : BUSFactory<TContext>, new()
    {
        public PickListController(TContext context, IViewInfo viewInfo)
