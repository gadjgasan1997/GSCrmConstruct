...
namespace GSCrmLibrary.Controllers.ApiControllers.BusinessComponentControllers
{
    ...
    public class DataMapObjectController<TContext, TBUSFactory>
        : MainBusinessComponentController<DataMapObject, BUSDataMapObject, TContext, DataBUSDataMapObjectFR<TContext>, TBUSFactory>
        where TContext : MainContext, new()
        where TBUSFactory : BUSFactory<TContext>, new()
    {
        public DataMapObjectController(TContext context, IViewInfo viewInfo)
