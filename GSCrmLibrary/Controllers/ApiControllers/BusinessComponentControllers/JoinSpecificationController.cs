...
namespace GSCrmLibrary.Controllers.ApiControllers.BusinessComponentControllers
{
    ...
    public class JoinSpecificationController<TContext, TBUSFactory>
        : MainBusinessComponentController<JoinSpecification, BUSJoinSpecification, TContext, DataBUSJoinSpecificationFR<TContext>, TBUSFactory>
        where TContext : MainContext, new()
        where TBUSFactory : BUSFactory<TContext>, new()
    {
        public JoinSpecificationController(TContext context, IViewInfo viewInfo)
