...
namespace GSCrmLibrary.Controllers.ApiControllers.BusinessComponentControllers
{
    ...
    public class ApplicationController<TContext, TBUSFactory>
        : MainBusinessComponentController<Application, BUSApplication, TContext, DataBUSApplicationFR<TContext>, TBUSFactory>
        where TContext : MainContext, new()
        where TBUSFactory : BUSFactory<TContext>, new()
    {
        public ApplicationController(TContext context, IViewInfo viewInfo)
