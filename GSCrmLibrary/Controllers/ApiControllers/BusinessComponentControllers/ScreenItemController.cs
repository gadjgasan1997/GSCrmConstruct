...
namespace GSCrmLibrary.Controllers.ApiControllers.BusinessComponentControllers
{
    ...
    public class ScreenItemController<TContext, TBUSFactory>
        : MainBusinessComponentController<ScreenItem, BUSScreenItem, TContext, DataBUSScreenItemFR<TContext>, TBUSFactory>
        where TContext : MainContext, new()
        where TBUSFactory : BUSFactory<TContext>, new()
    {
        public ScreenItemController(TContext context, IViewInfo viewInfo)
