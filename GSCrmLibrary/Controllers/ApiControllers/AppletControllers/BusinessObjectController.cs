...
namespace GSCrmLibrary.Controllers.ApiControllers.AppletControllers
{
    ...
    public class BusinessObjectController<TContext, TBUSFactory>
        : MainAppletController<BusinessObject, BUSBusinessObject, UIBusinessObject, TContext, DataBUSBusObjectFR<TContext>, TBUSFactory, BUSUIBusObjectFR<TContext>>
        where TContext : MainContext, new()
        where TBUSFactory : BUSFactory<TContext>, new()
    {
        public BusinessObjectController(TContext context, IScreenInfo screenInfo, IViewInfo viewInfo)
