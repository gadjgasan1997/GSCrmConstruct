...
namespace GSCrmLibrary.Controllers.ApiControllers.AppletControllers
{
    ...
    [ApiController]
    public class ApplicationItemController<TContext, TBUSFactory>
        : MainAppletController<ApplicationItem, BUSApplicationItem, UIApplicationItem, TContext, DataBUSApplicationItemFR<TContext>, TBUSFactory, BUSUIApplicationItemFR<TContext>>
        where TContext : MainContext, new()
        where TBUSFactory : BUSFactory<TContext>, new()
    {
        public ApplicationItemController(TContext context, IScreenInfo screenInfo, IViewInfo viewInfo)
