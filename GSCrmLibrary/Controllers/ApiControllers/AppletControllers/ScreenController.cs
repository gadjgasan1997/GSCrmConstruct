...
namespace GSCrmLibrary.Controllers.ApiControllers.AppletControllers
{
    ...
    public class ScreenController<TContext, TBUSFactory>
        : MainAppletController<Screen, BUSScreen, UIScreen, TContext, DataBUSScreenFR<TContext>, TBUSFactory, BUSUIScreenFR<TContext>>
        where TContext : MainContext, new()
        where TBUSFactory : BUSFactory<TContext>, new()
    {
        private readonly IViewInfo viewInfo;
        private readonly TContext context;
        public ScreenController(TContext context, IScreenInfo screenInfo, IViewInfo viewInfo)
