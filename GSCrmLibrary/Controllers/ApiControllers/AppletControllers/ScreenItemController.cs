...
namespace GSCrmLibrary.Controllers.ApiControllers.AppletControllers
{
    ...
    [ApiController]
    public class ScreenItemController<TContext, TBUSFactory>
        : MainAppletController<ScreenItem, BUSScreenItem, UIScreenItem, TContext, DataBUSScreenItemFR<TContext>, TBUSFactory, BUSUIScreenItemFR<TContext>>
        where TContext : MainContext, new()
        where TBUSFactory : BUSFactory<TContext>, new()
    {
        public ScreenItemController(TContext context, IScreenInfo screenInfo, IViewInfo viewInfo)
