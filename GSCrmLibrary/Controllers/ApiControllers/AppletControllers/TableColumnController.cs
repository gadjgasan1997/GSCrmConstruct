...
namespace GSCrmLibrary.Controllers.ApiControllers.AppletControllers
{
    ...
    public class TableColumnController<TContext, TBUSFactory>
        : MainAppletController<TableColumn, BUSTableColumn, UITableColumn, TContext, DataBUSTableColumnFR<TContext>, TBUSFactory, BUSUITableColumnFR<TContext>>
        where TContext : MainContext, new()
        where TBUSFactory : BUSFactory<TContext>, new()
    {
        public TableColumnController(TContext context, IScreenInfo screenInfo, IViewInfo viewInfo)
