...
namespace GSCrmLibrary.Controllers.ApiControllers.AppletControllers
{
    ...
    public class FieldController<TContext, TBUSFactory>
        : MainAppletController<Field, BUSField, UIField, TContext, DataBUSFieldFR<TContext>, TBUSFactory, BUSUIFieldFR<TContext>>
        where TContext : MainContext, new()
        where TBUSFactory : BUSFactory<TContext>, new()
    {
        public FieldController(TContext context, IScreenInfo screenInfo, IViewInfo viewInfo)
