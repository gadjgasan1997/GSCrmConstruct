...
namespace GSCrm.Controllers.Default.APIControllers.AppletsControllers
{
    ...
    public class TableColumnController 
        : MainAppletController<Table, TableColumn, BUSTableColumn, UITableColumn, DataBUSTableColumnFR, BUSUITableColumnFR>
    {
        public TableColumnController(ApplicationContext context,
